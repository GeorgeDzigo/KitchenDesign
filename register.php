...
$sqlinsert = $conn->prepare("insert into user_info(id, username, email, password) values( ?, ?, ?, ?)");
$sqlinsert->bind_param("ssss", $id, $uname, $email, $password);
$sqlinsert->execute();
$sqlinsert->close();
...
<hr>
  ...
  <hr>
    ...
    <input type="email" name="email" id="name" placeholder="E-mail">
